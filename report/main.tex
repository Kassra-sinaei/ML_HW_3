...
\begin{description}
    ...
    \item[$\bullet$] \lr{e step}: این متد تابع \lr{Q} را برای متغییر مشاهده نشده فعلی \lr{z} به روز رسانی می‌کند. از این متغیر در قسمت دوم الگوریتم استفاده خواهد شد.
    \item[$\bullet$] \lr{m step}: این متد پارامترهای میکسچرمدل را با بیشینه سازی تابع \lr{Q} به دست آمده از قسمت الگوریتم به روزرسانی می‌کند.
